...
Generar un diagrama de Walter y Lieth con la data de “datcli”, este debe
...
Recrea minuciosamente el siguiente diagrama de la rosa de los vientos
(pista: col=rainbow(8)).
...
![](CLIMATOL_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->

## NIVEL II

**EJERCICIO 3**

Convertir la data diaria de “tmax” en una data de medias mensuales.
...
```
    ...
    ## 
    ## =========== Homogenization of Tmax, 2001-2003. (Sat Jan 29 01:29:25 2022)
    ## 
    ...
    ## 
    ## ======== End of the missing data filling process, after 0.26 secs 
    ## 
    ## ----------- Final computations:
    ## 
...
Recortar la data mensual de Ptest desde 1965 hasta 2005. Homogeneizar
...
```
    ...
    ## 
    ## =========== Homogenization of Ptest, 1965-2005. (Sat Jan 29 01:29:25 2022)
    ## 
    ...
    ## HOMOGEN() APPLICATION OUTPUT  (From R's contributed package 'climatol' 3.1.1)
    ## 
    ## =========== Homogenization of Ptest-1, 1965-2005. (Sat Jan 29 01:29:25 2022)
    ## 
    ...
    ## 
    ## ======== End of the missing data filling process, after 8.94 secs 
    ## 
    ## ----------- Final computations:
    ## 
    ## ACmx: Station maximum absolute autocorrelations of anomalies
    ...
    ## 
    ## 
    ## ======== End of homogenization of overlapping areas, after 9.09 secs 
    ## 
    ## ----------- Generated output files: -------------------------
    ## 
...
Con la data homogenizada del ejercicio anterior (si no se ha realizado,
iniciar homogeneizando tal cual se menciona en el ejercicio 4) plotear
un gráfico de calor con las medias de precipitación mensual de acuerdo
con la latitud y longitud, este debe abarcar desde el punto 2.1°E 39.1°N
hasta el punto 3.5°E 40°N, con una separación de 0.001 entre líneas.
...
```
    ...
    ## File C:/Users/edgar/Desktop/IV CICLO/PROGRAMACIÓN/CLIMATOL/Ptest_1965-2005_m.nc (NC_FORMAT_CLASSIC):
    ## 
...
![](CLIMATOL_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
